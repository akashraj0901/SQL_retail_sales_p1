...
and quantiy > 4
and sale_date between '2022-11-01' and '2022-11-30'; 		-- Data format in MySQL "YYYY-MM-DD"

select * from retail_sales
where category = 'Clothing'
and quantiy > 4
and sale_date >= '2022-11-01'
and sale_date < '2022-12-01';				-- this code is more ideal beacuse in 'Between' it may miss some rows..



-- 3. Write a SQL query to calculate the total sales (total_sale) for each category.:
select category, sum(total_sale) as net_total, COUNT(*) from retail_sales
group by category;
...
where category = 'Beauty';									-- More Fast and cleaner
...
group by category, gender order by category asc;
...
group by customer_id order by net_sales desc limit 5;
